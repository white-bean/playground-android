...
public abstract class StompClient implements StompClientProvider {
    ...
    protected abstract void onStompMessage(final String frame) throws JSONException;
    ...
    @Override
    public void subscribe(final String destination, final String id, final String message) {
        this.transmitFrame(new Frame().setSubscribe(destination, id, message));
    }

    @Override
    public void subscribe(final String destination, String message) {
        this.subscribe(destination, "sub-1", message);
    }

    @Override
    public void unSubscribe(final String destination, final String id, final String message) {
        this.transmitFrame(new Frame().setUnsubscribe(destination, id, message));
    }

    @Override
    public void unSubscribe(final String destination, final String message) {
        this.unSubscribe(destination, "sub-0", message);
    }
