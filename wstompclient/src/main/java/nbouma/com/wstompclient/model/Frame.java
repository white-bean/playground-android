...
public class Frame {
    ...
    public Frame setSubscribe(final String destination, final String id,final String  message) { // sets default subscribe frame
    ...
    public Frame setUnsubscribe(final String destination, final String id,final String  message) {
